...
class Codex:
    """Synchronous client for creating threads and running TokenCode turns.
    ...
    def login_api_key(self, api_key: str) -> None:
        """Authenticate TokenCode with an API key."""
    ...
    def account(self, *, refresh_token: bool = False) -> GetAccountResponse:
        """Read the current TokenCode account state."""
        return self._client.account_read(GetAccountParams(refresh_token=refresh_token))

    def logout(self) -> None:
        """Clear the current TokenCode account session."""
    ...
    def thread_start(
        ...
        *,
        ...
        """Create a new TokenCode conversation thread."""
