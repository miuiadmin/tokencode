...
SDK_DISTRIBUTION_NAME = "tokencode-sdk"
RUNTIME_DISTRIBUTION_NAME = "tokencode-cli-bin"
RUNTIME_PACKAGE_ROOT = Path("src") / "tokencode_cli_bin"
...
def pinned_runtime_codex_path() -> Path:
    ...
    try:
        from tokencode_cli_bin import bundled_codex_path
...
def stage_python_sdk_package(staging_dir: Path, sdk_version: str) -> Path:
    ...
    sdk_bin_dir = staging_dir / "src" / "tokencode_sdk" / "bin"
...
def generate_v2_all(schema_dir: Path) -> None:
    ...
    out_path = sdk_root() / "src" / "tokencode_sdk" / "generated" / "v2_all.py"
...
def _notification_specs(schema_dir: Path) -> list[tuple[str, str]]:
    ...
    generated_source = (sdk_root() / "src" / "tokencode_sdk" / "generated" / "v2_all.py").read_text()
...
def generate_notification_registry(schema_dir: Path) -> None:
    ...
    out = sdk_root() / "src" / "tokencode_sdk" / "generated" / "notification_registry.py"
...
def _load_public_fields(
    ...
    if module_name == "tokencode_sdk.generated.v2_all":
...
def _load_generated_v2_all_module() -> types.ModuleType:
    ...
    module_name = "_tokencode_sdk_generated_v2_all_for_artifacts"
    sys.modules.pop(module_name, None)
    module_path = sdk_root() / "src" / "tokencode_sdk" / "generated" / "v2_all.py"
...
def generate_public_api_flat_methods() -> None:
    ...
    public_api_path = src_dir / "tokencode_sdk" / "api.py"
    ...
    thread_start_fields = _load_public_fields(
        "tokencode_sdk.generated.v2_all",
        "ThreadStartParams",
