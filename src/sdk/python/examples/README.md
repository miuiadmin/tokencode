...
All examples intentionally use only public SDK exports from `tokencode_sdk`
and `tokencode_sdk.types`.
...
```bash
python -m pip install tokencode-sdk
```

The SDK installs its pinned `tokencode-cli-bin` runtime dependency.
