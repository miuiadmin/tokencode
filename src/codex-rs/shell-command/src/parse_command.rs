...
/// The easiest way to iterate is to add unit tests and have TokenCode fix the implementation.
...
/// Tests are at the top to encourage using TDD + TokenCode to fix the implementation.
mod tests {
    use super::*;
