//! Shared model metadata types exchanged between TokenCode services and clients.
//!
...
/// Metadata describing a TokenCode-supported model.
#[derive(Debug, Clone, Deserialize, Serialize, TS, JsonSchema, PartialEq)]
...
/// Model metadata returned by the TokenCode backend `/models` endpoint.
