...
const MISSING_BWRAP_WARNING: &str = concat!(
    "TokenCode could not find bubblewrap on PATH. ",
    "Install bubblewrap with your OS package manager. ",
    "TokenCode will use the bundled bubblewrap in the meantime.",
);
const USER_NAMESPACE_WARNING: &str =
    "TokenCode's Linux sandbox uses bubblewrap and needs access to create user namespaces.";
pub(crate) const WSL1_BWRAP_WARNING: &str = concat!(
    "TokenCode's Linux sandbox uses bubblewrap, which is not supported on WSL1 ",
