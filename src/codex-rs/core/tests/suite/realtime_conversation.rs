...
const SILENT_CONTEXT_PREFIX: &str = "[BACKEND] Silent TokenCode context. Do not speak, acknowledge, or summarize this item. Wait for an explicit speakable handoff or direct user request.";
