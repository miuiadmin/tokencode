...
//! "leave the old title alone" or "clear the title TokenCode last wrote".
...
pub(crate) enum SetTerminalTitleResult {
    ...
    /// the title TokenCode manages, or some other fallback.
    NoVisibleContent,
}
...
/// or a previous program may have set before TokenCode started managing the title.
