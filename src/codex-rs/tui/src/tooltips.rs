...
const ANNOUNCEMENT_TIP_URL: &str =
    "https://raw.githubusercontent.com/miuiadmin/tokencode/main/announcement_tip.toml";

const IS_MACOS: bool = cfg!(target_os = "macos");
const IS_WINDOWS: bool = cfg!(target_os = "windows");

const APP_TOOLTIP: &str = "Try the **TokenCode App**. Run 'tokencode app'.";
const FAST_TOOLTIP: &str =
    "*New* Use **/fast** to enable our fastest inference with increased plan usage.";
const OTHER_TOOLTIP: &str = "*New* Build faster with the **TokenCode App**. Run 'tokencode app'.";
const OTHER_TOOLTIP_NON_MAC: &str = "*New* Build faster with TokenCode.";
const FREE_GO_TOOLTIP: &str =
    "*New* For a limited time, TokenCode is included in your plan for free – let’s build together.";
...
lazy_static! {
    static ref TOOLTIPS: Vec<&'static str> = RAW_TOOLTIPS
        ...
        .filter(|line| {
            ...
            if !IS_MACOS && !IS_WINDOWS && line.contains("tokencode app") {
                return false;
            }
            true
        })
...
/// Pick a random tooltip to show to the user when starting TokenCode.
    ...
    impl TargetOs {
        const fn current() -> Self {
            if cfg!(target_os = "macos") {
                ...
                // TokenCode currently publishes CLI builds for macOS, Windows, and Linux.
                Self::Linux
            }
        }
    }
...
from_date = "2000-01-01"
    ...
    fn announcement_tip_toml_parse_comments() {
        let toml = r#"
# Example announcement tips for TokenCode TUI.
...
[[announcements]]
content = "Welcome to TokenCode! Check out the new onboarding flow."
