...
mod tests {
    ...
    fn skill_load_warning_state_suppresses_repeated_active_errors() {
        ...
        let error = skill_error("/repo/.tokencode/skills/abc/SKILL.md", "invalid description");
    ...
    fn skill_load_warning_state_displays_new_message_for_active_path() {
        let mut state = SkillLoadWarningState::default();
        let initial = skill_error("/repo/.tokencode/skills/abc/SKILL.md", "invalid description");
        let changed = skill_error("/repo/.tokencode/skills/abc/SKILL.md", "invalid frontmatter");
...
⚠ /repo/.tokencode/skills/abc/SKILL.md: invalid description
");
    }
}
