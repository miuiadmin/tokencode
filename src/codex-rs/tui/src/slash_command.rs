...
impl SlashCommand {
    ...
    pub fn description(self) -> &'static str {
        match self {
            ...
            SlashCommand::Init => "create an AGENTS.md file with instructions for TokenCode",
            ...
            SlashCommand::App => "continue this session in TokenCode Desktop",
            SlashCommand::Quit | SlashCommand::Exit => "exit TokenCode",
            SlashCommand::Copy => "copy last response as markdown",
            SlashCommand::Raw => "toggle raw scrollback mode for copy-friendly terminal selection",
            SlashCommand::Diff => "show git diff (including untracked files)",
            SlashCommand::Mention => "mention a file",
            SlashCommand::Skills => "use skills to improve how TokenCode performs specific tasks",
            ...
            SlashCommand::Personality => "choose a communication style for TokenCode",
            ...
            SlashCommand::Permissions => "choose what TokenCode is allowed to do",
            ...
            SlashCommand::Logout => "log out of TokenCode",
