//! Shared implementation for `tokencode archive`, `tokencode delete`, and `tokencode unarchive`.
//!
...
async fn start_app_server_for_archive_command(
    ...
    let codex_home = find_codex_home().wrap_err("failed to find TokenCode home")?;
