...
impl HistoryCell for UpdateAvailableHistoryCell {
    fn display_lines(&self, width: u16) -> Vec<Line<'static>> {
        ...
        let update_instruction = if let Some(update_action) = self.update_action {
            ...
            line![
                "See ",
                "https://github.com/miuiadmin/tokencode".cyan().underlined(),
        ...
        let content = text![
            ...
            "https://github.com/miuiadmin/tokencode/releases/latest"
                .cyan()
                .underlined(),
        ];
    ...
    fn raw_lines(&self) -> Vec<Line<'static>> {
        let update_instruction = if let Some(update_action) = self.update_action {
            ...
            "See https://github.com/miuiadmin/tokencode for installation options.".to_string()
        };
        vec![
            ...
            Line::from("https://github.com/miuiadmin/tokencode/releases/latest"),
        ]
    }
