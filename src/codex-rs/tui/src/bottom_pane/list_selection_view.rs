...
mod tests {
    ...
    fn make_selection_view(subtitle: Option<&str>) -> ListSelectionView {
        ...
        let items = vec![
            SelectionItem {
                ...
                description: Some("TokenCode can read files".to_string()),
                is_current: true,
            ...
            SelectionItem {
                ...
                description: Some("TokenCode can edit files".to_string()),
                is_current: false,
                dismiss_on_select: true,
                ..Default::default()
            },
    ...
    fn renders_blank_line_between_subtitle_and_items() {
        let view = make_selection_view(Some("Switch between TokenCode approval presets"));
    ...
    fn theme_picker_subtitle_uses_fallback_text_in_94x35_terminal() {
        ...
        let codex_home = home.join(".tokencode");
    ...
    fn width_changes_do_not_hide_rows() {
        ...
        let items = vec![
            SelectionItem {
                ...
                description: Some(
                    "Optimized for TokenCode. Balance of reasoning quality and coding ability."
                        .to_string(),
                ),
                is_current: true,
                dismiss_on_select: true,
            ...
            SelectionItem {
                ...
                description: Some(
                    "Optimized for TokenCode. Cheaper, faster, but less capable.".to_string(),
                ),
                dismiss_on_select: true,
                ..Default::default()
            },
