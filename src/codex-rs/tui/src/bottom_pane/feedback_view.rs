...
const BASE_CLI_BUG_ISSUE_URL: &str =
    "https://github.com/miuiadmin/tokencode/issues/new?template=3-cli.yml";
    ...
    super::SelectionViewParams {
        ...
        items: vec![
            super::SelectionItem {
                name: "Yes".to_string(),
                description: Some(
                    "Share the current TokenCode session logs and diagnostics with the team for troubleshooting."
                        .to_string(),
                ),
...
mod tests {
    ...
    fn issue_url_available_for_bug_bad_result_safety_check_and_other() {
        ...
        let expected_external_url = "https://github.com/miuiadmin/tokencode/issues/new?template=3-cli.yml&steps=Uploaded%20thread:%20t";
