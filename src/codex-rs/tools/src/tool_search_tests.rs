...
fn default_search_text_uses_model_visible_namespace_metadata_once() {
    ...
    let spec = ToolSpec::Namespace(crate::ResponsesApiNamespace {
        ...
        description: "Manage TokenCode automations.".to_string(),
    ...
    assert_eq!(
        ...
        "codex_app Manage TokenCode automations. automation_update automation update Create or update automations. Automation options. mode Update mode. schedule Schedule settings. timezone IANA timezone."
    );
}
