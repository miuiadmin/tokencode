//! Persist TokenCode session rollouts (.jsonl) so sessions can be replayed or inspected later.
...
///
/// ```ignore
/// $ jq -C . ~/.tokencode/sessions/rollout-2025-05-07T17-24-21-5973b6c0-94b8-487b-a530-2aeb6098ae0e.jsonl
/// $ fx ~/.tokencode/sessions/rollout-2025-05-07T17-24-21-5973b6c0-94b8-487b-a530-2aeb6098ae0e.jsonl
/// ```
#[derive(Clone)]
...
impl RolloutRecorder {
    /// List threads (rollout files) under the provided TokenCode home directory.
    #[allow(clippy::too_many_arguments)]
...
fn precompute_log_file_info(
    ...
    // Resolve ~/.tokencode/sessions/YYYY/MM/DD path.
