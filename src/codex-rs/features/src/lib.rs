...
pub enum Feature {
    ...
    NetworkProxy,
    /// Respect host system proxy settings for TokenCode-owned network clients.
    RespectSystemProxy,
    /// Enable collab tools.
    Collab,
    ...
    /// Prompt TokenCode Apps connector auth failures through MCP URL elicitations.
    AuthElicitation,
...
pub const FEATURES: &[FeatureSpec] = &[
    ...
    FeatureSpec {
        ...
        stage: Stage::Experimental {
            name: "Memories",
            menu_description: "Allow TokenCode to create new memories from conversations and bring relevant memories into new conversations.",
            announcement: "NEW: TokenCode can now generate and use memories. Try it now with `/memories`",
        },
        default_enabled: false,
    },
    FeatureSpec {
    ...
    FeatureSpec {
        ...
        stage: Stage::Experimental {
            ...
            announcement: "NEW: Network proxy can now be enabled from /experimental. Restart TokenCode after enabling it.",
        },
        default_enabled: false,
    },
    FeatureSpec {
    ...
    FeatureSpec {
        ...
        stage: if cfg!(any(
            ...
            Stage::Experimental {
                ...
                menu_description: "Keep your computer awake while TokenCode is running a thread.",
