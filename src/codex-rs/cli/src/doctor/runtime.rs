//! Captures how this TokenCode process was launched.
//!
...
/// Builds the process provenance row for the current TokenCode executable.
///
...
pub(super) fn search_check() -> DoctorCheck {
    ...
    if status != CheckStatus::Ok {
        check = check.remediation("Install ripgrep or repair the bundled TokenCode package.");
    }
    check
}
