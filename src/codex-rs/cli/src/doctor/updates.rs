//! Diagnoses whether TokenCode update paths target the running installation.
//!
...
const GITHUB_LATEST_RELEASE_URL: &str = "https://api.github.com/repos/miuiadmin/tokencode/releases/latest";
...
fn update_action_label(context: &InstallContext) -> &'static str {
    match &context.method {
        InstallMethod::Npm => "npm install -g tokencode",
        InstallMethod::Bun => "bun install -g tokencode",
