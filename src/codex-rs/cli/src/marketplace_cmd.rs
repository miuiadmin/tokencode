...
#[derive(Debug, Parser)]
#[command(bin_name = "tokencode plugin marketplace")]
...
enum MarketplaceSubcommand {
    ...
    /// List plugin marketplaces TokenCode is currently considering and their roots.
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "tokencode plugin marketplace add",
    after_help = "Examples:\n  tokencode plugin marketplace add ./path/to/marketplace\n  tokencode plugin marketplace add owner/repo --ref main\n  tokencode plugin marketplace add https://github.com/owner/repo --sparse plugins/foo"
)]
...
#[derive(Debug, Parser)]
#[command(bin_name = "tokencode plugin marketplace list")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "tokencode plugin marketplace upgrade",
    after_help = "Examples:\n  tokencode plugin marketplace upgrade\n  tokencode plugin marketplace upgrade debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "tokencode plugin marketplace remove",
    after_help = "Example:\n  tokencode plugin marketplace remove debug"
)]
