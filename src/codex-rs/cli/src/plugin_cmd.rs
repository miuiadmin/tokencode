...
#[derive(Debug, Parser)]
#[command(bin_name = "tokencode plugin")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "tokencode plugin add",
    after_help = "Examples:\n  tokencode plugin add sample@debug\n  tokencode plugin add sample --marketplace debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "tokencode plugin list",
    after_help = "Examples:\n  tokencode plugin list\n  tokencode plugin list --marketplace debug\n  tokencode plugin list --json\n  tokencode plugin list --available --json"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "tokencode plugin remove",
    after_help = "Examples:\n  tokencode plugin remove sample@debug\n  tokencode plugin remove sample --marketplace debug"
)]
