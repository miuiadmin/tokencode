        ...
        file_system_sandbox_policy
            ...
            .filter_map(|entry| {
                ...
                if project_subpath != Path::new(".git")
                    ...
                    && project_subpath != Path::new(".tokencode")
                {
                    return None;
                }
...
mod tests {
    ...
    fn writable_roots_under_symlinked_ancestors_bind_real_target() {
        ...
        let logical_codex = logical_home.join(".tokencode");
        ...
        std::os::unix::fs::symlink(&real_codex, &logical_codex)
            .expect("create symlinked tokencode home");
    ...
    fn missing_read_only_subpath_uses_empty_file_bind_data() {
        ...
        assert_empty_directory_mounted_read_only(&args.args, &workspace.join(".tokencode"));
    ...
    fn missing_project_root_metadata_carveouts_use_metadata_path_masks() {
        ...
        let dot_codex = path_to_string(&temp_dir.path().join(".tokencode"));
