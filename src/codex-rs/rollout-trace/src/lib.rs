//! Trace bundle format, writer, and reducer for TokenCode rollouts.
//!
//! This crate owns the trace schema. Hot-path TokenCode code should depend on the
...
/// Shared recorder context for inference attempts within one TokenCode turn.
...
/// Request data for the canonical TokenCode tool boundary.
...
/// Append-only writer used by hot-path TokenCode instrumentation.
