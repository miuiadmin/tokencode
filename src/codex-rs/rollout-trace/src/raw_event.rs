...
pub enum RawTraceEventPayload {
    ...
    InferenceCancelled {
        ...
        /// before TokenCode stopped consuming the stream.
        upstream_request_id: Option<String>,
        /// Why TokenCode stopped consuming the provider stream before a terminal response event.
        reason: String,
    ...
    ToolCallRuntimeStarted {
        tool_call_id: ToolCallId,
        /// Runtime/protocol observation for how TokenCode began executing the tool.
        runtime_payload: RawPayloadRef,
    },
    ToolCallRuntimeEnded {
        tool_call_id: ToolCallId,
        status: ExecutionStatus,
        /// Runtime/protocol observation for how TokenCode finished executing the tool.
        runtime_payload: RawPayloadRef,
    },
    ToolCallEnded {
        tool_call_id: ToolCallId,
