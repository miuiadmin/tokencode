...
/// One TokenCode thread/session participating in the rollout.
///
...
/// Provenance for a traced TokenCode thread.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
...
/// One activation of the TokenCode runtime for one thread.
///
/// A TokenCode turn groups protocol/runtime work for one thread activation.
