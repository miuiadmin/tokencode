...
/// Runtime operation requested by the model, a JS code cell, or TokenCode itself.
///
...
pub struct ToolCall {
    ...
    /// Original invocation at the TokenCode tool boundary.
    ///
    ...
    /// they describe how TokenCode executed the request, not what the caller sent.
