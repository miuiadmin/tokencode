...
/// TokenCode conversation/session UUID.
...
/// Process/session ID returned by TokenCode's terminal runtime.
...
/// Canonical reduced graph for one TokenCode rollout.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct RolloutTrace {
    pub schema_version: u32,
    /// Unique identity for this trace capture.
    ///
    /// `rollout_id` names the TokenCode rollout/session being observed. `trace_id`
