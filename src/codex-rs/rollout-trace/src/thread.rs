...
impl ThreadTraceContext {
    ...
    ///
    /// Trace startup is best-effort. A tracing failure must not make the TokenCode
    ...
    /// Emits typed TokenCode turn lifecycle events from protocol lifecycle events.
    ...
    /// what TokenCode did while executing that boundary.
    ...
    /// Builds reusable inference trace context for one TokenCode turn.
    ///
