...
pub struct ThreadRealtimeStartParams {
    ...
    /// Leaves TokenCode response handoffs to the client's explicit append calls instead of forwarding
    ...
    /// Optional prefix added to automatic TokenCode response items when `codexResponsesAsItems` is true.
    #[ts(optional = nullable)]
    ...
    /// Set to false to start without TokenCode's startup context. Omitted or null includes it.
    #[ts(optional = nullable)]
