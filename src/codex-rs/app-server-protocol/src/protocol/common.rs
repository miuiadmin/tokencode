...
pub enum AuthMode {
    /// OpenAI API key provided by the caller and stored by TokenCode.
    ApiKey,
    /// ChatGPT OAuth managed by TokenCode (tokens persisted and refreshed by TokenCode).
    Chatgpt,
    ...
    ChatgptAuthTokens,
    /// Programmatic TokenCode auth backed by a registered Agent Identity.
    #[serde(rename = "agentIdentity")]
    #[ts(rename = "agentIdentity")]
    #[strum(serialize = "agentIdentity")]
    AgentIdentity,
    /// Programmatic TokenCode auth backed by a personal access token.
    #[serde(rename = "personalAccessToken")]
    #[ts(rename = "personalAccessToken")]
    #[strum(serialize = "personalAccessToken")]
    PersonalAccessToken,
    /// Amazon Bedrock bearer token managed by TokenCode.
...
impl AuthMode {
    ...
    /// Returns whether this mode is backed by TokenCode services rather than a direct model API.
...
client_request_definitions! {
    ...
    /// Spawn a standalone process (argv vector) without a TokenCode sandbox.
...
server_notification_definitions! {
    ...
    /// This event is internal-only. Used by TokenCode Cloud.
        ...
        let request = ClientRequest::Initialize {
            ...
            params: v1::InitializeParams {
                client_info: v1::ClientInfo {
                    ...
                    title: Some("TokenCode VS Code Extension".to_string()),
                    version: "0.1.0".to_string(),
                },
