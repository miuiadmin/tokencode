...
//!
//! The history is stored at `~/.tokencode/history.jsonl` with **one JSON object per
...
/// Filename that stores the message history inside `~/.tokencode`.
...
pub async fn append_entry(
    ...
    // Resolve `~/.tokencode/history.jsonl` and ensure the parent directory exists.
