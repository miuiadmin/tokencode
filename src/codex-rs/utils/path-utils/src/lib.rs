//! Path normalization, symlink resolution, and atomic writes shared across TokenCode crates.
...
/// Compare paths after applying TokenCode's filesystem normalization.
///
