...
**Disclaimer**: This code is pretty complex and TokenCode did not manage to write it so before updating the code, make
sure to deeply understand it and don't blindly trust TokenCode on it. Feel free to update the documentation as you
modify the code
