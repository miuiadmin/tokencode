...
pub fn builtin_approval_presets() -> Vec<ApprovalPreset> {
    vec![
        ApprovalPreset {
            id: "read-only",
            label: "Read Only",
            description: "TokenCode can read files in the current workspace. Approval is required to edit files or access the internet.",
        ...
        ApprovalPreset {
            id: "auto",
            label: "Default",
            description: "TokenCode can read and edit files in the current workspace, and run commands. Approval is required to access the internet or edit other files. (Identical to Agent mode)",
            approval: AskForApproval::OnRequest,
            active_permission_profile: ActivePermissionProfile::new(
        ...
        ApprovalPreset {
            id: "full-access",
            label: "Full Access",
            description: "TokenCode can edit files outside this workspace and access the internet without asking for approval. Exercise caution when using.",
