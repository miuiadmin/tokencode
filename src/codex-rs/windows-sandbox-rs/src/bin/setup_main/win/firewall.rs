...
const OFFLINE_BLOCK_RULE_FRIENDLY: &str = "TokenCode Sandbox Offline - Block Non-Loopback Outbound";
const OFFLINE_BLOCK_LOOPBACK_TCP_RULE_FRIENDLY: &str =
    "TokenCode Sandbox Offline - Block Loopback TCP (Except Proxy)";
const OFFLINE_BLOCK_LOOPBACK_UDP_RULE_FRIENDLY: &str = "TokenCode Sandbox Offline - Block Loopback UDP";
