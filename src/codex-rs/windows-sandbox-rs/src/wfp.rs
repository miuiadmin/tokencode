...
const SESSION_NAME: &str = "TokenCode Windows Sandbox WFP";
const PROVIDER_NAME: &str = "TokenCode Windows Sandbox WFP";
const PROVIDER_DESCRIPTION: &str = "Persistent WFP provider for TokenCode Windows sandbox filters";
const SUBLAYER_NAME: &str = "TokenCode Windows Sandbox WFP";
const SUBLAYER_DESCRIPTION: &str = "Persistent WFP sublayer for TokenCode Windows sandbox filters";

// WFP identifies persistent providers, sublayers, and filters by stable GUIDs.
// These values are TokenCode-owned identities; do not regenerate them unless we
...
/// Installs the persistent TokenCode WFP filters for `account`.
///
...
/// Ensures the persistent TokenCode WFP provider exists.
...
/// Ensures the persistent TokenCode sublayer exists under the TokenCode provider.
