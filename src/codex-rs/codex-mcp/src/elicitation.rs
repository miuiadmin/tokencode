...
//!
//! RMCP clients call into this module when a server asks TokenCode to elicit data
//! from the user. It decides whether the request can be automatically accepted,
//! must be declined by policy, or should be surfaced as a TokenCode protocol event
...
/// generated by TokenCode rather than copied from the MCP connection, so separate runtimes may reuse
