...
The builder creates a canonical TokenCode package directory:
...
host platform. On Linux, that default is a musl target to match TokenCode release
...
downloads and verifies the matching TokenCode-built V8 release pair before invoking
