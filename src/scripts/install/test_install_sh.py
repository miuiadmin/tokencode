...
class InstallShTest(unittest.TestCase):
    def test_metadata_fetch_failure_is_not_reported_as_missing_assets(self) -> None:
        ...
        self.assertEqual(
            requests,
            [
                "https://api.github.com/repos/miuiadmin/tokencode/releases/tags/"
                f"rust-v{VERSION}"
            ],
        )
        self.assertIn(
            f"Could not fetch GitHub release metadata for TokenCode {VERSION}",
            result.stderr,
        )
        self.assertNotIn("Could not find TokenCode package", result.stderr)
    ...
    def test_exact_release_fetches_metadata_once(self) -> None:
        ...
        self.assertEqual(
            ...
            [
                "https://api.github.com/repos/miuiadmin/tokencode/releases/tags/"
                f"rust-v{VERSION}",
                "https://github.com/miuiadmin/tokencode/releases/download/"
    ...
    def test_latest_release_reuses_version_metadata(self) -> None:
        ...
        self.assertEqual(
            requests,
            [
                "https://api.github.com/repos/miuiadmin/tokencode/releases/latest",
                "https://github.com/miuiadmin/tokencode/releases/download/"
                f"rust-v{VERSION}/codex-package_SHA256SUMS",
            ],
        )
...
def run_installer(
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        env.update(
            {
                "TOKENCODE_HOME": str(root / "codex-home"),
