#!/usr/bin/env python3
"""Stage and optionally package the tokencode npm module."""
...
CODEX_NPM_NAME = "tokencode"
CODEX_PACKAGE_COMPONENT = "codex-package"

# `npm_name` is the local optional-dependency alias consumed by `bin/codex.js`.
# The underlying package published to npm is always `tokencode`.
CODEX_PLATFORM_PACKAGES: dict[str, dict[str, str]] = {
    "codex-linux-x64": {
        "npm_name": "tokencode-linux-x64",
        "npm_tag": "linux-x64",
    ...
    "codex-linux-arm64": {
        "npm_name": "tokencode-linux-arm64",
        "npm_tag": "linux-arm64",
    ...
    "codex-darwin-arm64": {
        "npm_name": "tokencode-darwin-arm64",
    ...
    "codex-win32-arm64": {
        "npm_name": "tokencode-win32-arm64",
        "npm_tag": "win32-arm64",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build or stage the TokenCode CLI npm package.")
    parser.add_argument(
        "--package",
